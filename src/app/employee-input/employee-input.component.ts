...
export class EmployeeInputComponent {
  ...
  constructor(private activeRoute:ActivatedRoute){
   const routeParams = activeRoute.snapshot.paramMap.get('_id');
    console.log(activeRoute.snapshot.paramMap.get('_id'));
    if(routeParams!= null){
      let _id =parseInt(routeParams);
      console.log(_id);
    ...
    this.employeeForm=new FormGroup({
      ...
      joining_date:new FormControl(this.employee.emp_joiningDate,[Validators.required]),
      emp_salary:new FormControl(this.employee.emp_salary,[Validators.required, Validators.min(0)]),
      dept_code:new FormControl(this.employee.emp_deptCode,[Validators.required]),
      experience:new FormControl(this.employee.emp_experience,[Validators.required, Validators.min(0), Validators.max(85)]),
      ...
      secrete_code:new FormControl(this.employee.secrete_code,[Validators.required, Validators.minLength(3), Validators.maxLength(12)]),
